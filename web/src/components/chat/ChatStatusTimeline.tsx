...
const stageLabels: Record<ChatProcessingStage, string> = {
  ...
  searching_open_sources: 'Ищу информацию в интернете',
  open_sources_found: 'Источники найдены',
  reading_open_sources: 'Читаю найденные страницы',
  open_sources_ready: 'Веб-источники подготовлены',
