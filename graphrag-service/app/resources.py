...
from .embeddings import DeterministicEmbeddings, YandexEmbeddings
...
if (
    ...
    and (not settings.yandex_api_key or not settings.yandex_folder_id)
):
    raise RuntimeError(
...
openai_client_options = {
    "api_key": settings.yandex_api_key or "demo-key",
    "project": settings.yandex_folder_id or "demo-folder",
