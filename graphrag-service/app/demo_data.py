...
async def extract_demo_document(request: ExtractRequest) -> dict[str, Any]:
    ...
    entities = [
        ...
        _entity("technology-rutrol-ad-171", "technology", "Rutrol AD 171",
                _source(request.documentId, 6, "Лабораторные испытания"),
        ...
        _entity("experiment-laboratory-rutrol", "experiment",
                ...
                _source(request.documentId, 7, "Лабораторные испытания"),
        ...
        _entity("conclusion-optimal-dose", "conclusion",
                ...
                _source(request.documentId, 8, "Выводы лабораторных испытаний"),
                {"statement": "при рабочей концентрации 3 % достигнута эффективность свыше 99 %"}),
